...
namespace AdventuresWebApp.Controllers
{
    public class AddressesController : Controller
    {
        ...
        {
            var adventureWorksContext = _context.Address.Include(a => a.StateProvince);
        ...
        {
            ViewData["StateProvinceId"] = new SelectList(_context.StateProvince, "StateProvinceId", "CountryRegionCode");
            return View();
        }
