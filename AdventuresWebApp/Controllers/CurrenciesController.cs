...
namespace AdventuresWebApp.Controllers
{
    public class CurrenciesController : Controller
    {
        ...
        public CurrenciesController(AdventureWorksContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var currency = await _context.Currency
                .SingleOrDefaultAsync(m => m.CurrencyCode == id);
            if (currency == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            var currency = await _context.Currency.SingleOrDefaultAsync(m => m.CurrencyCode == id);
            if (currency == null)
            {
                return NotFound();
            }
